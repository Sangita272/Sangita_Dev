...
const BASE_URL = "http://13.232.100.13:6010/v1/admin/";
const IMG_URL = "http://13.232.100.13:6010/";
...
async function requestData(url, method, params = {}) {
  ...
  myHeaders.append("userType", "Admin");
  myHeaders.append("Content-Type", "application/json");
  myHeaders.append("Access-Control-Allow-Origin", "http://13.232.100.13:6010");
...
async function fileUplodeDynamic(
  ...
  let bash_url = "http://13.232.100.13:6010/v1/admin/";
  let apiUrl = bash_url + url;
  ...
  let headers = {
    ...
    "Access-Control-Allow-Origin": "http://128.199.25.86:5012",
